...
public class WhaleWatcher {
	...
	public static void main(String[] args) {
		...
		int averageLength = ((right.getLength() + blue.getLength() + sperm.getLength() + humpback.getLength())
				/ whales.size());
	...
	public static String getHeaviestWhale1(ArrayList<Whale> whales) {// only returns one heavy whale when should return
																		// two
